  ...
  handleSubmit(event) {
    ...
    return (<div>
        <form onSubmit={this.handleSubmit}>
            ...
            <input type="password" name="password_confirmation" placeholder="Password Confirmation" value={this.state.password_confirmation} onChange={this.handleChange}></input>
